...
SKILLS=(forge-discover forge-decompose forge-atom forge-audit forge-armour forge-implement forge-test-writer forge-implementer forge-validate)
...
verify_install() {
    ...
    say "       /forge-audit     /forge-armour     /forge-implement  /forge-validate"
    say
